...
public class Archer : Enemy
{
    ...
    protected override void Start()
    {
        ...
        idleState = new ArcherIdleState(this, stateMachine, characterStats, anchorTile);
        battleState = new ArcherBattleState(this, stateMachine, characterStats, agent);
        chaseState = new ArcherChaseState(this, stateMachine, characterStats);
